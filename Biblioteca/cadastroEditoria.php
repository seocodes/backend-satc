        ...
        if(isset($_POST['Cadastrar']) || isset($_POST['Alterar']) || isset($_POST['Excluir']) || isset($_POST['Pesquisar'])) {
            ...
            if(isset($_POST['Cadastrar'])) {
                ...
                if(empty($nome)) {
                    ...
                    if ($resultado) {
                        ...
                        echo "Erro ao cadastrar editora: " . mysqli_error($conectar);
                    }
                }
            }
            ...
            if(isset($_POST['Alterar'])) {
                ...
                if(empty($codigo) || empty($nome)) {
                    ...
                    if ($resultado && mysqli_affected_rows($conectar) > 0) {
                        echo "Dados da editora alterados com sucesso!";
            ...
            if(isset($_POST['Excluir'])) {
                ...
                if(empty($codigo)) {
                    ...
                    $check_sql = "SELECT COUNT(*) as count FROM livro WHERE codeditora = '$codigo'";
            ...
            //fecha a conexao, boa pratica

            mysqli_close($conectar);
            //fecha a div resultado
            echo "</div>";
        }
        ?>
    </div>
